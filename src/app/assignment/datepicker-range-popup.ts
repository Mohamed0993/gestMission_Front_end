...
export class NgbdDatepickerRangePopup {
  ...
  @Output()
  dateDep = new EventEmitter<NgbDate>();
  @Output()
  dateRet = new EventEmitter<NgbDate>();
  ...
  onDateSelection(date: NgbDate) {
    ...
    //this.TableDate.push(this.fromDate);

    this.dateDep.emit(this.fromDate);
    this.dateRet.emit(this.toDate!)
